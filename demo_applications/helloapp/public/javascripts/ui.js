const initUI = () => {
  ...
  // Set meeting ID and name
  document.getElementById('set_name').innerHTML = `${name}`;
  document.getElementById('set_meeting_id').innerHTML = `#${meetingID}`;
  ...
  startVideoBtn.onclick = () => {
    ...
    VoxeetSDK.conference.startVideo(VoxeetSDK.session.participant)
      .then(() => {
        ...
        document.getElementById('microphone-logo').style.display ='none';
      })
      .catch((err) => console.error(err));
  };
  ...
  stopVideoBtn.onclick = () => {
    ...
    VoxeetSDK.conference.stopVideo(VoxeetSDK.session.participant)
      .then(() => {
        ...
        document.getElementById('microphone-logo').style.display ='block';
      })
      .catch((err) => console.error(err));
  };
